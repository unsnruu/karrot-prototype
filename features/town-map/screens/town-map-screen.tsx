...
import {
  ...
  type TownMapPin,
  type TownMapPost,
  type TownMapQuickAction,
  type TownMapSearchCategory,
} from "@/lib/town-map";
...
function TownMapCategoryChip({ category }: { category: TownMapSearchCategory }) {
  return (
    <button
      className={cn(
...
function TownMapQuickActionCard({ action }: { action: TownMapQuickAction }) {
  return (
...
function TownMapMarker({ pin }: { pin: TownMapPin }) {
  return (
...
function TownMapPostCard({ post }: { post: TownMapPost }) {
  return (
