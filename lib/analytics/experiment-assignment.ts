...
export const VISITOR_EXPERIMENT_STORAGE_KEY = "karrot_visitor_experiment_context.v7";
export const VISITOR_EXPERIMENT_COOKIE_KEY = "karrot_visitor_experiment_context_v7";
