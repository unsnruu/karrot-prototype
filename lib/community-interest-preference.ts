...
export const COMMUNITY_INTEREST_TOPIC_STORAGE_KEY = "karrot_community_interest_topic.v1";
export const COMMUNITY_INTEREST_TOPIC_COOKIE_KEY = "karrot_community_interest_topic_v1";
...
export function parseCommunityInterestTopicIds(rawTopicIds: string | null | undefined) {
  ...
  try {
    ...
    // Fall back to the previous single-topic format.
  }
